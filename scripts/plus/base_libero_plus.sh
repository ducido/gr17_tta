...
for TASK in "${TASKS[@]}"; do
    ...
    LOG_DIR="eval_logs/libero_plus/${pertube}/${suite}/baseline_20k_tt_update${tt_update}_num_step_tt_in_traj${num_step_tt_in_traj}_${max_episode_steps}steps_eps${EPISODES}_ah${action_horizon}/$NAME"
