...
for TASK in "${TASKS[@]}"; do
    ...
    LOG_DIR="eval_logs/libero_10/baseline_nenvs${N_envs}_${max_episode_steps}steps_eps${EPISODES}_ah${action_horizon}/$NAME"
    ...
    gr00t/eval/sim/LIBERO/libero_uv/.venv/bin/python gr00t/eval/rollout_policy_vis_cam.py \
        --algo cam \
        --save_cam_video_dir $LOG_DIR/grad_cam_mask_avgpool \
        --n_episodes $EPISODES \
